...
| host-based detection resistance | needs-work | explicitly out of current implementation | requires repeated-flow synthetic host aggregation and resistance metrics | implement after wireeval fixtures are stable |
