...
| protocol feature corpus | needs-work | explicitly out of current implementation | needs separate corpus design and review | define feature corpus before wire-shape expansion |
| wire-shape generator | needs-work | explicitly out of current implementation | needs separate diversity and collapse gates | define safe wire-shape evaluation baselines |
