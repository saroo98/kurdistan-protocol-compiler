...
| concrete network/proxy/VPN adapters | needs-work | explicitly out of current implementation | requires separate threat model, protocol review, and adapter-specific tests | start with concrete local proxy ingress design review |
