...
variable "region" {
  ...
  validation {
    ...
    error_message = "Qualification control-plane resources must remain in an approved EU region."
  }
}
variable "spanner_configuration" {
  ...
  validation {
    ...
    error_message = "Qualification Spanner is frozen to eur6."
  }
}
variable "kms_location" {
  ...
  validation {
    ...
    error_message = "Qualification KMS must remain in the approved EU boundary."
  }
}
variable "bucket_location" {
  ...
  validation {
    ...
    error_message = "Qualification buckets must remain in the approved EU boundary."
  }
}
