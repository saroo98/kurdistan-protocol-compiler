...
func validateEvidenceOverlaysV1(root string, manifest committedEvidenceManifestV1) (map[string]string, error) {
	finalGuardPre, err := validatePhase8FinalGuardMaintenanceOverlayV1(root, manifest.Phase8FinalGuardMaintenanceOverlays)
	if err != nil {
		return nil, err
	}
...
func validatePhase8WO801AdoptionOverlayAtPostV1(root string, currentAtPost map[string]string, overlays map[string]phase2CompleteOverlayV1) (map[string]string, error) {
	...
	wantPaths := []string{
		"testdata/evidence/phase8-wo801-adoption-2026-07-17.json",
		"cmd/kgen/main_test.go",
		"internal/audit/codegen_test.go",
		"internal/audit/security.go",
		"internal/audit/security_test.go",
	...
	wantPre := map[string]string{
		"cmd/kgen/main_test.go":                            "f3756c80bd358535e929a8bffa4ef79129f346318fb6304fdd01abd6c915a846",
		"internal/audit/codegen_test.go":                   "00ac00353fda287944ba5fd1965a130830514b2807c5df1ea46eccbcc1299791",
		"internal/audit/security.go":                       "d71fc4a337b995790ee397b944e3d7cf47ba675dc9204eeb8b5f2c513250b73d",
		"internal/audit/security_test.go":                  "dba0df11ef69fa6364a262d2f3fdf4bb8046f089fa314148ed5a7ae13c4cf7d8",
		"internal/codegen/authorization_v1_test.go":        "c9b8f29d924a37e1b2fbba5b6a69ef04fc6043e4c2e0f77aafd162edf66d5adc",
		"internal/runtime/policy_enforcement_test.go":      "ab7ab4f454448750a82e5a50a8acfba96b08ca5c4c492539c371f4a6f9f49241",
		"internal/testkit/importrules/importrules_test.go": "1c465b2026c31246a3685f96849604d0879e0025e892fc6a4b3875bf0ef09a17",
	}
	overlay, ok := overlays[name]
...
func TestPhase8WO801AdoptionOverlayMutationsV1(t *testing.T) {
	...
	for name, mutate := range mutations {
		t.Run(name, func(t *testing.T) {
			...
			mutate(overlays)
			if _, err := validatePhase8WO801AdoptionOverlayV1(root, overlays); err == nil {
