...
func TestNoImplicitPinsFourPathSHA256Evidence(t *testing.T) {
	...
	if err := committedevidence.VerifyHistoricalSet(root, "WO-041", []committedevidence.ExpectedEntry{
		{Path: "cmd/kgen/main.go", PreEvidence: "79c6bb76ae234e08b8f2b1e2248ea1e4d4d0770fa52e9fcab1aa3914618a3ed4"},
		{Path: "cmd/kgen/main_test.go", PreEvidence: "bf6f2a7e2840c12d56a652f486fecda8297f839d36697bef786b31cfd6e2273b"},
		{Path: "internal/runtime/policy_enforcement_test.go", PreEvidence: "ABSENT"},
		{Path: "internal/runtime/profile_loader_test.go", PreEvidence: "ABSENT"},
	}); err != nil {
		t.Fatal(err)
	}
}
