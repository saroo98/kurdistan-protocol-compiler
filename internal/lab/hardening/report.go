...
func packagesChecked() []string {
	return []string{
		...
		"internal/operator/relayprocess",
		"internal/contracts/readiness/keyexchangeplan",
		"internal/operator/relayauthplan",
		"internal/contracts/readiness/operationalhardening",
		"internal/contracts/android/androidreview",
		"internal/contracts/android/androidruntime",
		"internal/contracts/android/androidvpnservice",
		"internal/contracts/android/androidcarrier",
		"internal/contracts/readiness/productionreadiness",
		"internal/lab/concretelocaladapter",
		"internal/transport/transportbundle",
		"internal/transport/pathrace",
		"internal/transport/pathhealth",
		"internal/contracts/carrier/carrierreview",
		"internal/contracts/readiness/measurementreview",
		"internal/contracts/carrier/httpscarrierreview",
		"internal/contracts/carrier/httpslikecarrier",
		"internal/contracts/carrier/httpscarrieradversary",
		"internal/contracts/carrier/constrainedcarrierreview",
		"internal/contracts/carrier/constrainedcarrier",
		"internal/contracts/carrier/multicarrierselect",
		"internal/contracts/carrier/carriercollapse",
