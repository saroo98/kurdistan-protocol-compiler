...
type AuditThresholds struct {
	...
	MinAdapterPolicyCombinations            int     `json:"min_adapter_policy_combinations"`
	MaxAdapterAdversaryDominantRatio        float64 `json:"max_adapter_adversary_dominant_ratio"`
	MinAdapterAdversaryDiversityScore       float64 `json:"min_adapter_adversary_diversity_score"`
	MinAdapterScenarioSuccess               float64 `json:"min_adapter_scenario_success"`
	MaxLocalAdapterAdversaryDominantRatio   float64 `json:"max_local_adapter_adversary_dominant_ratio"`
	MinLocalAdapterAdversaryDiversityScore  float64 `json:"min_local_adapter_adversary_diversity_score"`
	MinLocalAdapterScenarioSuccess          float64 `json:"min_local_adapter_scenario_success"`
	MaxByteTransportAdversaryDominantRatio  float64 `json:"max_byte_transport_adversary_dominant_ratio"`
	MinByteTransportAdversaryDiversityScore float64 `json:"min_byte_transport_adversary_diversity_score"`
	MinByteTransportScenarioSuccess         float64 `json:"min_byte_transport_scenario_success"`
}
...
func DefaultThresholds() AuditThresholds {
	return AuditThresholds{
		...
		MinAdapterPolicyCombinations:            6,
		MaxAdapterAdversaryDominantRatio:        0.94,
		MinAdapterAdversaryDiversityScore:       0.12,
		MinAdapterScenarioSuccess:               0.90,
		MaxLocalAdapterAdversaryDominantRatio:   0.94,
		MinLocalAdapterAdversaryDiversityScore:  0.12,
		MinLocalAdapterScenarioSuccess:          0.90,
		MaxByteTransportAdversaryDominantRatio:  0.94,
		MinByteTransportAdversaryDiversityScore: 0.12,
		MinByteTransportScenarioSuccess:         0.90,
	}
}
