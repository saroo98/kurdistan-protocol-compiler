...
func TestCodegenAuthorizationCatalogSixPathSHA256AndTestdataInventory(t *testing.T) {
	...
	if err := committedevidence.VerifyHistoricalSet(root, "WO-042", []committedevidence.ExpectedEntry{
		{Path: "internal/audit/codegen.go", PreEvidence: "a81e381a01dd4122f83e7c38bb5f1d4fa95e7e27d30949743055e5cebebf50ab"},
		{Path: "internal/audit/codegen_test.go", PreEvidence: "d23ba4b99175f3289628a694d788edfcebb06d004b9df8bda759bf26ddea2aaa"},
		{Path: "testdata/codegen/profile-authorization-v1.json", PreEvidence: "ABSENT"},
		{Path: "cmd/kcheck/main.go", PreEvidence: "21e2b04eab3fb4ba8daac4d977174239523bd458d9a6d53e7896357e70200bcb"},
		{Path: "cmd/kcheck/registry_test.go", PreEvidence: "86772d52db8f6a8348c8e766e35063e2522bacb4ecea85a1ddea891c024a81bf"},
