...
if ($null -eq $legacyBaseline -or $null -eq $legacyTree -or
    $legacyBaseline.Value -cne '8ef19dd57520c2930d12e81ed7769a6ec6cf3326' -or
    $legacyTree.Value -cne '3a51879991388775abffa9e3df7984d624b63852') {
    throw 'BV-01: historical pre-sanitization provenance is not preserved separately'
}
