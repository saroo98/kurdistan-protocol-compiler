...
export const links = {
  ...
  selfHosting:
    'https://github.com/saroo98/kurdistan-protocol-compiler/blob/main/docs/self-hosting/QUICKSTART.md',
  license:
    'https://github.com/saroo98/kurdistan-protocol-compiler/blob/main/LICENSE',
} as const
