...
const areas={privacy:['src/prototype/app.html','tests/artifacts/refinement.test.mjs'],anchors:['src/components/experiences.mjs','tests/artifacts/refinement.test.mjs'],hero:['src/phase3/refinement.mjs','src/client/phase3.js'],methods:['src/refinement/methods.json','src/client/search.js'],phone:['src/client/app-design.js','src/client/prototype-adapter.js','src/client/preview.js'],profiles:['src/prototype/app.html','src/client/app-design.js'],languages:['src/refinement/copy.json','src/i18n/messages.json'],verification:['tests/refinement.browser.mjs','tests/artifacts/production.test.mjs','performance-budgets.json']};
